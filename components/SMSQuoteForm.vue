  ...
  <section id="sms-quote" class="relative z-20 -mt-20 sm:-mt-32 lg:-mt-16">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <form
        ...
        class="w-full lg:max-w-4xl xl:max-w-3xl 2xl:max-w-4xl mx-auto rounded-2xl border border-slate-200 bg-white shadow-sm px-4 sm:px-6 py-4 sm:py-5 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4"
        novalidate
      >
        <!-- Left: icon + text -->
        <div class="flex items-center gap-2 sm:gap-3 sm:w-auto flex-shrink-0">
          <div
            class="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-lg bg-brand-50 text-brand-700 border border-brand-100 flex-shrink-0"
          >
        ...
        <div class="w-full flex flex-row items-stretch gap-3 sm:gap-4 sm:flex-1">
          ...
          <div class="flex-auto min-w-0">
            ...
            <input
              ...
              class="form-field form-field--compact sms-input placeholder:text-slate-400"
              pattern="^[0-9()+\-\s]{7,}$"
          ...
          <div class="w-auto">
            <button
              ...
              aria-label="Text me pricing"
              class="inline-flex items-center justify-center rounded-xl bg-brand-600 px-3 sm:px-6 py-3 text-base font-semibold text-white hover:bg-brand-700 transition-colors shadow-sm disabled:opacity-70 disabled:cursor-not-allowed shrink-0 whitespace-nowrap"
            >
