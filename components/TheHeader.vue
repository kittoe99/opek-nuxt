      ...
      <div class="flex h-20 items-center justify-between">
        ...
        <a href="#" class="group inline-flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-8 h-8 group-hover:scale-110 transition-transform">
            <path fill="#0f172a" d="M16 0C9.37 0 4 5.37 4 12c0 7.47 10.9 19.35 11.43 19.92a.75.75 0 0 0 1.14 0C17.1 31.35 28 19.47 28 12 28 5.37 22.63 0 16 0z"></path>
            <path fill="#34d399" d="M16 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16zm-3.5 7.5l2 3 2.5-4 2.5 4h-9l2.5-3z"></path>
          </svg>
          <img
        ...
        <button
          @click="toggleMenu"
          class="lg:hidden inline-flex h-11 w-11 items-center justify-center rounded-xl bg-white/10 text-white ring-1 ring-white/20 hover:bg-white/15 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 transition"
      ...
      >
        ...
        <div class="absolute inset-0 opacity-[0.03] pointer-events-none">
          <svg viewBox="0 0 400 800" class="w-full h-full" preserveAspectRatio="none">
            <path fill="#0a8a4c" d="M0,800 L0,400 L100,300 L200,450 L300,250 L400,380 L400,800 Z"/>
            <path fill="#0a8a4c" d="M0,400 L0,200 L80,120 L160,240 L240,100 L320,190 L400,150 L400,400 Z"/>
          </svg>
        </div>

        <!-- Decorative Background Elements -->
        <div class="absolute top-0 right-0 w-64 h-64 bg-brand-600/20 rounded-full blur-3xl -translate-y-32 translate-x-32"></div>
        <div class="absolute bottom-0 left-0 w-48 h-48 bg-brand-500/20 rounded-full blur-3xl translate-y-24 -translate-x-24"></div>
        ...
        <nav class="relative flex-1 overflow-y-auto p-6" aria-label="Mobile">
          <ul class="space-y-2">
            <li>
              <a @click="closeMenu" class="group relative flex items-center gap-4 rounded-2xl px-4 py-4 text-[15px] font-semibold text-white/80 hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5 hover:text-white transition-all overflow-hidden" href="#home">
                <div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/0 group-hover:from-white/10 group-hover:to-white/5 transition-all"></div>
            ...
            <li>
              <a @click="closeMenu" class="group relative flex items-center gap-4 rounded-2xl px-4 py-4 text-[15px] font-semibold text-white/80 hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5 hover:text-white transition-all overflow-hidden" href="#services">
                <div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/0 group-hover:from-white/10 group-hover:to-white/5 transition-all"></div>
                <div class="relative h-11 w-11 rounded-xl bg-white/5 group-hover:bg-brand-600 group-hover:shadow-lg group-hover:shadow-brand-600/30 flex items-center justify-center transition-all group-hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-5 w-5">
            ...
            <li>
              <a @click="closeMenu" class="group relative flex items-center gap-4 rounded-2xl px-4 py-4 text-[15px] font-semibold text-white/80 hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5 hover:text-white transition-all overflow-hidden" href="#about">
                <div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/0 group-hover:from-white/10 group-hover:to-white/5 transition-all"></div>
                <div class="relative h-11 w-11 rounded-xl bg-white/5 group-hover:bg-brand-600 group-hover:shadow-lg group-hover:shadow-brand-600/30 flex items-center justify-center transition-all group-hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-5 w-5">
            ...
            <li>
              <a @click="closeMenu" class="group relative flex items-center gap-4 rounded-2xl px-4 py-4 text-[15px] font-semibold text-white/80 hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5 hover:text-white transition-all overflow-hidden" href="#reviews">
                <div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/0 group-hover:from-white/10 group-hover:to-white/5 transition-all"></div>
                <div class="relative h-11 w-11 rounded-xl bg-white/5 group-hover:bg-brand-600 group-hover:shadow-lg group-hover:shadow-brand-600/30 flex items-center justify-center transition-all group-hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-5 w-5">
            ...
            <li>
              <a @click="closeMenu" class="group relative flex items-center gap-4 rounded-2xl px-4 py-4 text-[15px] font-semibold text-white/80 hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5 hover:text-white transition-all overflow-hidden" href="#process">
                <div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/0 group-hover:from-white/10 group-hover:to-white/5 transition-all"></div>
                <div class="relative h-11 w-11 rounded-xl bg-white/5 group-hover:bg-brand-600 group-hover:shadow-lg group-hover:shadow-brand-600/30 flex items-center justify-center transition-all group-hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-5 w-5">
            ...
            <li class="pt-4 mt-4 border-t border-white/10">
              <a @click="closeMenu" class="group relative flex items-center gap-4 rounded-2xl px-4 py-4 text-[15px] font-semibold text-white/80 hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5 hover:text-white transition-all overflow-hidden" href="#contact">
                <div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/0 group-hover:from-white/10 group-hover:to-white/5 transition-all"></div>
                <div class="relative h-11 w-11 rounded-xl bg-white/5 group-hover:bg-brand-600 group-hover:shadow-lg group-hover:shadow-brand-600/30 flex items-center justify-center transition-all group-hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-5 w-5">
